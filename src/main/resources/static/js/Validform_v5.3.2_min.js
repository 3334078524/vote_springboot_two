...
(function (d, f, b) {
    ...
    function c() {
        ...
        // "input[name=userName]").after('<div id="Validform_msg"><div class="Validform_info"></div></div>')
        j = d('<span id="Validform_msg"><span class="Validform_info"></span></span>').appendTo("body");
        alert("zhifuc"+document.getElementsByName("userName").values())
